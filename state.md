...
- **Fase:** 3 — **en curso** (bloque de preparación). Bloque **`fase-03-filtro` (A2.1) CERRADO ✔ (2026-09-25)**, verificación **PASA**; detalle en **`_fases/fase-03-filtro/change-doc.md`**. *(Fase 2 cerrada el 2026-09-23.)*
